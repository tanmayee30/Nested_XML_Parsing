...
emailfrom  = "xx"                          #Senders email addr
#emailto    = "xx"                    #Receivers email addr
fileToSend =  Date+".csv"                                       #26-Jun-2017.csv"
username   = "xx"
password   = "xx"
################################## SOAP response ##########################

centre_name = ['Amul-Khadawali','Amul -Talvali','Amul-Kude','Amul-Lalthane','Amul-Musarne','Amul-Malwada','Amul Pedpargaon','Cavinkare','Saras-Chetawala',
...
################################## MSG service #################################
    ...
    auth_id = "MAMJI0ODC5MZBLNTVJNW"
    auth_token = "Y2ViNTczMGJlMDQ0ZDI5MjBlYTMxYTRkODZiYjQ3"

    params = {
        'src' : '919623715037', # Sender's phone number with country code
        'dst' : '918983144295', # Receiver's phone Number with country code
        'text': u"Site Name: "+centers[0]+"\nTime: "+y2+"\nMilk Temperature: "+values[1]+"\nBattery Temperature: "+values[0]+"\n",
#       'url' : "http://example.com/report/", # The URL to which with the stat$
